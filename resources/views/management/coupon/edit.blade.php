                                ...
                                <div class="header">
                                    ...
                                    <div class="row my-2">
                                        <div class=" col-6 ">
                                            ...
                                            <input  value="{{$category->start_date}}" id="" name="start_date"  placeholder="Please choose start date......" autocomplete="off">

                                        </div>
                                        <div class="col-6">
                                            <input value="{{$category->expiry_date}}" id="myPicker" name="expiry_date" class="flatPicker flatpickr-input active" placeholder="Please choose end date......"  autocomplete="off">
                                        ...
                                        <div class="col">
                                            <div class="main_container m-3">
                                                    <div class="main imagebox position-relative rounded-3 overflow-hidden">
                                                        ...
                                                        <input type="file" name="editimage[{{$image->id}}]" accept=".jpg,.gif,.png"
                                                               class="main_file w-100 h-100 form-control position-absolute  opacity-0" />
                                                        <div class="img-thumb">
                                                            <img class="main_img d-block w-100 h-100 position-absolute" src="{{asset('images/media/'.$image->image)}}">
                                                        </div>
                                                    </div>
                                                <a class="btn mt-3 add_clone fw-normal border-0 shadow-none">Add More</a>
                                                <a class="btn mt-3 remove_lol fw-normal border-0 shadow-none" data-id="{{$image->id}}">Remove</a>
