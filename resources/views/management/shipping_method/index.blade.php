                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('shipping_method.create')}}" type="button" class="btn btn-primary">Add
                            </a>
                        </div>
                                ...
                                @foreach($shippingMethods as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('shipping_method.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('shipping_method.destroy',$row->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
