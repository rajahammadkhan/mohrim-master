...
@section('title')
    Language Edit - {{config('app.dashboard')}}
                        ...
                        <div class="col-md-6">
                            <div class="card py-4">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> language name </strong></label>
                                            <div class="form-line">
                                                <input  value="{{$language->language_name}}" type="text" id="erp_question_text"
                                                       class="form-control" name="language_name"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> language code </strong></label>
                                            <div class="form-line">
                                                <input   value="{{$language->language_code}}  " type="text" id="erp_question_text"
                                                       class="form-control" name="language_code"
