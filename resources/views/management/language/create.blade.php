...
@section('title')
    Language Create - {{config('app.dashboard')}}
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('language_name') }}" type="text" id="erp_question_text"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('language_code') }}" type="text" id="erp_question_text"
