                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('language.create')}}" type="button" class="btn btn-primary">Add
                            </a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-3">Language name</th>
                                    <th class="col-lg-3">Language code</th>
                                ...
                                @foreach($language as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('language.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('language.destroy',$row->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
