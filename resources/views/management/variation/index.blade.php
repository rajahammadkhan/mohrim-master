                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('variation.create')}}" type="button" class="btn btn-primary">Add
                            </a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-3">Attribute Name</th>
                                    <th class="col-lg-3">Variations</th>
                                ...
                                @foreach($variation as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-primary" style="color:white;">{{$row->variations_view}}</span>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('variation.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('variation.destroy',$row->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
