...
@section('title')
    Variation Edit - {{config('app.dashboard')}}
    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('variation.update',$language->id)}}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                            <div class="card py-4">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> Attribute Name </strong></label>
                                            <div class="form-line">
                                                <input  value="{{$language->attribute_name}}" type="text" id="erp_question_text"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label for="email_address1"> <strong> Variations </strong></label>
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="variations" data-role="tagsinput"
                                                       value="{{$language->variations_view}}" style="display: none;">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row my-1">
