    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('post.update',$category->id)}}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
...
{{--                                                           class="main_file w-100 h-100 form-control position-absolute  opacity-0" />--}}
{{--                                                    <div class="img-thumb">--}}
{{--                                                        <img class="main_img d-block w-100 h-100 position-absolute" src="{{asset('images/blog'.'/'.$category->image)}}" alt="">--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
{{--                                        </div>--}}
