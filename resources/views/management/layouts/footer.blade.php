...
<script>
    $(document).ready(function () {
        $('.is_variant').on('click', function () {

            if ($(this).is(':checked'))
            {
            $(this).parents('.test').find('.ic').slideDown('slow');
            $('.stock').slideUp('slow');
                $('.stk').attr('required', false);

            }else {
                $(this).parents('.test').find('.ic').slideUp('slow');
                // $(this).parents('.stmain').find('.stock').show();
                $('.stock').slideDown('slow');
                $('.stk').attr('required', true);
