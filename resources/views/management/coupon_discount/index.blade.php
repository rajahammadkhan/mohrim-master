...
@section('title')
    CoupenDiscount - {{config('app.dashboard')}}
@endsection
@section('content')
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            <a href="{{route('coupon_discount.create')}}" type="button" class="btn btn-primary"> Add CoupenDiscount
                            </a>
                        </div>
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-3">Discount Type</th>
                                    <th class="col-lg-3">Is Applied</th>
                                ...
                                @foreach($coupon_discount as $row)
                                    <tr>
                                        ...
                                        @endif
                                        <td>
                                            <a class="btn bg-blue btn-circle" href="{{route('coupon_discount.show',$row->id)}}">
                                                ...
                                                <div class="modal-dialog modal-dialog-centered" role="document">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <form action="{{route('coupon_discount.destroy',$row->id)}}" method="post">
                                                                @csrf
                                                                @method('DELETE')
