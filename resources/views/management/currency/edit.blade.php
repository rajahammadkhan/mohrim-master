...
@section('title')
    Currency Edit - {{config('app.dashboard')}}
    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <form action="{{route('currency.update',$language->id)}}"  method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    <div class="row">
                        <div class="col-md-6">
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input  value="{{$language->currency_name}}" type="text" id="erp_question_text"
                                                        class="form-control" name="currency_name"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> currency Symbol </strong></label>
                                            <div class="form-line">
                                                <input  value="{{$language->currency_symbol}}" type="text" id="erp_question_text"
                                                        class="form-control" name="currency_symbol"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> currency code </strong></label>
                                            <div class="form-line">
                                                <input   value="{{$language->currency_code}}  " type="text" id="erp_question_text"
                                                         class="form-control" name="currency_code"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            <label for="email_address1"> <strong> currency rate </strong></label>
                                            <div class="form-line">
                                                <input   value="{{$language->currency_rate}}  " type="text" id="erp_question_text"
                                                         class="form-control" name="currency_rate"
                                                         placeholder="currency rate" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row my-1">
                                        ...
                                        <div class=" col-12">
                                            ...
                                            <select class="form-control select2" name="country_id" id="Quiz-type" data-placeholder="Select">
                                                ...
                                                <option {{$country->id == $language->country_id ? 'Selected' : '' }}  value="{{$country->id}}">{{$country->name}}</option>
                                                @endforeach
