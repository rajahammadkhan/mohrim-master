                ...
                <div class="card">
                    <div class="header">
                        <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                            ...
                            <a href="{{route('currency.create')}}" type="button" class="btn btn-primary">Add
                            </a>
                        </div>
                        ...
                        <div class="body table-responsive">
                            <table class="table" id="myTable">
                                ...
                                <tr>
                                    ...
                                    <th class="col-lg-3">Currency name</th>
                                    <th class="col-lg-3">Currency code</th>
                                    <th class="col-lg-3">Currency rate</th>
                                ...
                                @foreach($currency as $row)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a class="btn bg-blue btn-circle" href="{{route('currency.show',$row->id)}}">
