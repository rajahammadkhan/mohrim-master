...
@section('title')
    Currency Create - {{config('app.dashboard')}}
                                ...
                                <div class="header">
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('currency_name') }}" type="text" id="erp_question_text"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('currency_symbol') }}" type="text" id="erp_question_text"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('currency_code') }}" type="text" id="erp_question_text"
                                    ...
                                    <div class="row">
                                        <div class=" col-12">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('Currency_rate') }}" type="text" id="erp_question_text"
