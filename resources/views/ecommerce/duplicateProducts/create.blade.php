    ...
    <div class="container-fluid px-4">
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    ...
                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6">
                        <ul class="breadcrumb breadcrumb-style ">
                            <li class="breadcrumb-item">
                                <h4 class="page-title">Duplicate Products </h4>
                            </li>
                ...
                <form action="{{route('duplicateProducts.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-md-8">
                            <div class="card py-4">
                                            ...
                                            <div class="col-lg-12 mx-auto m-0">
                                                <div class="test">
                                                    <div class="form-group m-0">
                                                        <label class="d-block">
                                                            <input {{ old('is_variant') == '1' ? 'checked' : '' }} value="1"
                                    ...
                                    <div class="form-group">
                                        ...
                                        @if($countries->isNotEmpty())
                                            @foreach($countries as $country)
                                                <label class="d-block">
                                                    <input value="{{$country->id}}" type="checkbox"
                                ...
                                <div class="body">
                                            ...
                                            @foreach($categories as $category)
                                                ...
                                                <label class="d-block">
                                                    <input value="{{$category->id}}" type="checkbox"
                                                           class="continue_selling" name="categories[]" class="py-2">
                                                    <span class="py-2">
                                        {{$category->title}}
                                              </span>
                                                    @endforeach
                                    ...
                                    <div class="form-group ">
                                        ...
                                        <select class="form-control select2" name="brand_id"
                                            ...
                                            @foreach($brands as $brand)
                                                <option {{ old('brand') == $brand ? 'Selected' : '' }} value={{$brand->id}}>{{$brand->title}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    <div class="form-group ">
                                        <div class="testing">
                                            ...
                                            <select id="chartappend" class="form-control select2" name="chart_id"
                                                ...
                                                @foreach($chart as $brand)
                                                    <option value={{$brand->id}}>{{$brand->name}}</option>chartappend
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="row my-3">
                                        <div class="col-lg-12 mx-auto">
                                            <div class="test">
                                                <label class="d-block">
                                                    <input {{ old('continue_selling') == 'yes' ? 'checked' : '' }} value="1"
                                    ...
                                    <div class="row my-3">
                                        <div class="col-lg-12 mx-auto">
                                            ...
                                            <div class="form-line">
                                                <input value="{{old('product_tax')}}" type="text" id="erp_question_text"
                ...
                <script>
                    ...
                    {{--    $.ajax({--}}
                    {{--    type: 'POST',--}}
                    {{--    url: '{{url('admin/related-products')}}',--}}
                    {{--    data: {--}}
                    {{--    _token: '{{csrf_token()}}',--}}
                    {{--    id:val,--}}
                                ...
                                <div class="col-3">
                                    <label for="email_address1">{{$node->attribute_name}} </label>
                                            ...
                                            <select class="form-control"
                                                      name="variation_option[${x}][][{{$node->id}}]"
                                                  data-placeholder="Select">
...
{{--                                 @if($countries->isNotEmpty())--}}
                                ...
                                {{--                                <label class="d-block">--}}
                                {{--                                    <input value="{{$country->id}}" type="checkbox"--}}
                                {{--                                                       class="continue_selling" name="country_var[${x}]" class="py-2">--}}
                                {{--                                                <span class="py-2">--}}
                                {{--                                        {{$country['countries']['name']}} ({{$country->currency_code}})--}}
                                {{--                                              </span>--}}
                                {{--                                                @endforeach--}}
